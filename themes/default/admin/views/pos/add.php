...
<html sigplusextliteextension-installed="true" sigwebext-installed="true">
<head>
    <meta charset="utf-8">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn blightOrange pos-tip" id="opened_bills"
                           title="<?= lang('suspended_sales') ?>" data-placement="bottom" data-html="true"
                    ...
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="close_register"
                           title="<?= lang('close_register') ?>" data-placement="bottom" data-html="true"
                    ...
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="add_expense" title="<?= lang('add_expense') ?>"
                    ...
                    <li class="dropdown">
                        <a class="btn bdarkGreen pos-tip" id="today_sale"
                           title="<?= lang('today_sale') ?>" data-placement="bottom" data-html="true"
                    ...
                    <div id="leftdiv">
                        ...
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                            ...
                                            <div class="btn-group-vertical btn-block">
                                                ...
                                                <button type="button" class="btn btn-danger btn-block btn-flat" id="reset"
	                                                ...
	                                                <i class="fa fa-times-circle"
                                                    	style="margin-left: 5px;"></i> <?= lang('cancel'); ?>
                                                </button>
                                            </div>
                                        </div>
                                        <!--
                                ...
                                <!-- fooled codeigniter to take my signature field -->
                ...
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        ...
                        <div class="well well-sm well_1 form-group" id="repair_info" style="display: none">
                            <div class="row">
                                <div class="col-sm-3" id="type_details">
                                    ...
                                    ?>
                                    <?php $sst = array('Select Status' => lang('Select Status'),
                                        'In Progress' => lang('In Progress'),
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <?= form_textarea('repair_note', '', 'id="repair_note" class="form-control kb-text skip" style="height: 34px;" placeholder="' . lang('Repair_Note') . '" maxlength="250"'); ?>
                                </div>
                            ...
                            <div class="row">
                                <div id="sign_area" class="col-sm-5">
                                    <canvas class="table-bordered" id="cnv" name="cnv" width="520" height="100"
                                            style="background: white;"></canvas>
                                </div>
                                <canvas name="SigImg" id="SigImg" width="500" height="100"
                                        style="display:none;"></canvas>
                                <div class="col-sm-3 col-sm-offset-4" style="padding-top: 15px; padding-left: 0;">
                                    <form id="signature-form"
                                          action="<?php echo base_url();?>themes/default/admin/views/pos/save.php"
                                        ...
                                        <br>
                                        <br>
                                        <input type="hidden" name="sigStringData" value="">
                                        <input type="hidden" name="sigRawData" value="">
                                        <input type="hidden" name="signature" id="signature-data" value="">
                                        <input type="hidden" id="signature_getname" value="">
                                        <input type="hidden" name ="signature_file_name" id="signature_file_name" value="">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <?= form_textarea('sale_note', '', 'id="sale_note" class="form-control kb-text skip" style="height: 60px;" placeholder="' . lang('sale_note') . '" maxlength="250"'); ?>
                                </div>
                                <div class="col-sm-6">
                                    <?= form_textarea('staffnote', '', 'id="staffnote" class="form-control kb-text skip" style="height: 60px;" placeholder="' . lang('staff_note') . '" maxlength="250"'); ?>
                                </div>
                            </div>
                        </div>
...
<div class="modal" id="prModal" tabindex="-1" role="dialog" aria-labelledby="prModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true" id="closeEditModal"><i
                                class="fa fa-2x">&times;</i></span><span class="sr-only"><?= lang('close'); ?></span>
                </button>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ($Settings->product_serial) { ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control kb-text" id="pserial">
                            </div>
                        </div>
                    <?php } ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#paymentModal').on('shown.bs.modal', function (e) {
            $('#amount_1').focus();
            // Disabled auto quick cash value in input field
            //$('#quick-payable').click();
        });
        ...
        $("#add_item").autocomplete({
            ...
            response: function (event, ui) {
                if ($(this).val().length >= 200 && ui.content[0].id == 0) {
                    ...
                    //mahbub//$(this).data('ui-autocomplete')._trigger('select', 'autocompleteselect', ui);
                    //$(this).autocomplete('close');
                } else if (ui.content.length == 1 && ui.content[0].id == 0) {
                    //mahbub//bootbox.alert
                    ('<?=lang('no_match_found')?>', function () {
                        $('#add_item').focus();
                    });
                    //mahbub//$(this).val('');
        ...
        //mahbub//<?php if ($pos_settings->tooltips) {
        //mahbub//echo '$(".pos-tip").tooltip();';
    }
        ?>
        ...
        $(document).on('click', '#submit-sale', function (e) {
            ...
            if (types == 'Repair' && type_detail == 'Select Status') {
                bootbox.alert('<?=lang('Please select Repair Status')?>');
                return false;
            }
            ...
            if ($('#amount_1').val() == '') {
                bootbox.alert('Please enter the amount to complete the transaction!');
                return false;
            }

            if (($('#paid_by_1').val() == 'Debit_Card' || $('#paid_by_1').val() == 'CC') && $('#pcc_no_1').val() == '') {
                bootbox.alert('<?=lang('Please Enter Last 4 Digits of the Card')?>');
                return false;
            }
