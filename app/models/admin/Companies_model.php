...
class Companies_model extends CI_Model
{
    ...
    {
//        $this->db->select("id, (CASE WHEN company = '-' THEN CONCAT(name, ' (', phone, ')') ELSE CONCAT(company, ' (', phone, ')') END) as text, (CASE WHEN company = '-' THEN CONCAT(name, ' (', phone, ')') ELSE CONCAT(company, ' (', phone, ')') END) as value, phone", FALSE);
        $this->db->select("id, CONCAT(name, ' (', phone, ')') as text,CONCAT(name, ' (', phone, ')') as value, phone", FALSE);
